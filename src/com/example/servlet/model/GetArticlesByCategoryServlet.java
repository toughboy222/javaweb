...
public class GetArticlesByCategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (category == null || category.trim().isEmpty()) { //
            ...
            out.write(gson.toJson(new ErrorResponse("分类名称不能为空"))); //
            out.flush(); //
            out.close(); //
            return; //
        }
        ...
        try {
            ...
            if ("综合".equalsIgnoreCase(category) || "all".equalsIgnoreCase(category)) { //
                sql = "SELECT a.id, a.title, LEFT(a.content, 200) as content_snippet, a.likes_count, " + // 添加 a.likes_count
                        ...
                        "ORDER BY a.publish_date DESC LIMIT 20"; //
                ...
                sql = "SELECT a.id, a.title, LEFT(a.content, 200) as content_snippet, a.likes_count, " + // 添加 a.likes_count
                        ...
                        "DATE_FORMAT(a.publish_date, '%Y-%m-%d %H:%i') as publish_date, a.category " +
                        "FROM articles a LEFT JOIN users u ON a.author_phone = u.phone " +
                        "WHERE a.category = ? ORDER BY a.publish_date DESC"; //
                pstmt = conn.prepareStatement(sql); //
